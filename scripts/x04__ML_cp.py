...
# リーキングを改善させたバージョンを作成する

class F01__MLModel:
    """
    A class for ML models based on scripts/README.md.
    """
    def __init__(self, is_validation: bool = False, is_test: bool = False, is_submision: bool=False, handle_imbalance: bool = False, model_name: str = "LightGBM", hyperparameters: dict = None, experiment_id: int = 0, timestamp: str=None):
        self.is_validation = is_validation
        self.is_test = is_test
        self.is_submision = is_submision
